    ...
    return (
       ...
       <!--Body--> */}
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            ...
                            <div class="view overlay rounded z-depth-1">
                                <img src="https://mdbootstrap.com/img/Photos/Others/project4.jpg" class="img-fluid" alt="Sample project" />
       ...
       <!--Body--> */}
                        ...
                        <div class="col-lg-4 col-md-6 mb-4">
                            ...
                            <div class="view overlay rounded z-depth-1">
                                <img src="https://mdbootstrap.com/img/Photos/Others/images/88.jpg" class="img-fluid" alt="Sample project" />
       ...
       <!--Body--> */}
                                <div class="modal-body">
                                    <div class="text-center">
                                        ...
                                        <ul className="text-left">
                                            <li>This is a web app about money managament, using ReactJs and SQL.</li>
                                            <li>Users can import bank statements as .csv file</li>
                                            <li>This app used bayes to learn how to match a transaction with a category</li>
                                        </ul>
                                    </div>
                                </div>
